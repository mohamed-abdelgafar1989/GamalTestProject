...
namespace DAL
{
    ...
    [DataContract]
    public partial class ItemSubmittionHistory
    {
    	
    
        [DataMember] public System.Guid Id { get; set; }
    
        [DataMember] public System.Guid SubmittedItemId { get; set; }
    
        [DataMember] public System.Guid HistoryRecordId { get; set; }
    
        [DataMember] public System.DateTime SubmittionDate { get; set; }
    
        [DataMember] public System.Guid SubmittionStatusId { get; set; }
