...
namespace DAL
{
    ...
    [DataContract]
    public partial class Action_SecurityRole_MailTemplate
    {
    	
    
        [DataMember] public System.Guid Id { get; set; }
    
        [DataMember] public Nullable<System.Guid> ActionId { get; set; }
    
        [DataMember] public Nullable<System.Guid> SecurityRoleId { get; set; }
    
        [DataMember] public Nullable<System.Guid> TemplateId { get; set; }
