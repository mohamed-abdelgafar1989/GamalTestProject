...
namespace DAL
{
    ...
    [DataContract]
    public partial class StepCompletedItemHistory
    {
    	
    
        [DataMember] public System.Guid Id { get; set; }
    
        [DataMember] public Nullable<System.Guid> HistoryRecordId { get; set; }
    
        [DataMember] public Nullable<System.Guid> CompletedItemId { get; set; }
        ...
        public virtual ObjectStepHistory ObjectStepHistory { get; set; }
